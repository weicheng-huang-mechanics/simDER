...
void elasticBendingForce::computeJb()
{
	for(int i=1; i < rod->ne;i++)
    {
        ...
        - kappa1 / (chi * norm2_e) * (Id3 - te * te.adjoint())
        ...
        - kappa1 / (chi * norm2_f) * (Id3 - tf*tf.adjoint())
        + 1.0 / (4.0 * norm2_f) * (kb_o_d2f + d2f_o_kb);

        D2kappa1DeDf=
        - kappa1/(chi* norm_e * norm_f) *(Id3 + te*tf.adjoint())
        ...
        - kappa2 / (chi * norm2_e) * (Id3 - te*te.adjoint())
        ...
        - kappa2 / (chi * norm2_f) * (Id3 - tf*tf.adjoint())
        - 1.0 / (4.0 * norm2_f) * (kb_o_d1f + d1f_o_kb);

        D2kappa2DeDf
        = -kappa2/(chi * norm_e * norm_f) * (Id3 + te*tf.adjoint())
